  ...
  return (
    <Container sx={{ mt: 20, textAlign: "center", my: 3 }}>
      <Seo
        ...
        description="Read Go Creative Solutions terms and conditions to learn more about your rights and responsibilities."
        keywords="terms, conditions, Go Creative Solutions"
      />
      {isLoading ? (
        <Box
          sx={{
        ...
        <Box sx={{ mt: 15 }}>
          ...
          <Typography variant="body1" color="initial" sx={{ mt: 3 }}>
            {t(
              "Read our terms below to learn more about your rights as a Go Creative Solutions user."
            )}
          </Typography>
